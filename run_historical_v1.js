// V1 Strategy Simulation on Historical Data (Shoe 301-412)
// Extracted from PNG screenshots

// Historical rounds extracted from screenshots
const historicalRounds = [
  ...
  { game: 353, round: 1, dealerUp: 'J', dealerTotal: 24,
    players: [
      { cards: ['K', '3', 'J'], total: 23, outcome: 'LOSS', recommended: 'STAND', actual: 'HIT' },
      { cards: ['8', '7', '8'], total: 23, outcome: 'LOSS', recommended: 'STAND', actual: 'HIT' },
      { cards: ['6', 'A', '3'], total: 20, outcome: 'WIN', recommended: 'STAND', actual: 'HIT' }
    ] },
  { game: 353, round: 5, dealerUp: '5', dealerTotal: 24,
    players: [
      { cards: ['3', 'Q'], total: 13, outcome: 'WIN', recommended: 'STAND', actual: 'STAND' },
      { cards: ['6', '7'], total: 13, outcome: 'WIN', recommended: 'STAND', actual: 'STAND' },
      { cards: ['Q', '8'], total: 18, outcome: 'WIN', recommended: 'STAND', actual: 'STAND' },
      { cards: ['7', '5'], total: 12, outcome: 'WIN', recommended: 'STAND', actual: 'STAND' },
      { cards: ['9', 'A'], total: 20, outcome: 'WIN', recommended: 'STAND', actual: 'STAND' },
      { cards: ['9', '3', '6'], total: 18, outcome: 'WIN', recommended: 'STAND', actual: 'HIT' }
    ] },
  { game: 353, round: 10, dealerUp: 'Q', dealerTotal: 20,
    players: [
      { cards: ['5', 'J'], total: 15, outcome: 'LOSS', recommended: 'HIT', actual: 'STAND' },
      { cards: ['6', 'Q'], total: 16, outcome: 'LOSS', recommended: 'HIT', actual: 'STAND' },
      { cards: ['Q', 'J'], total: 20, outcome: 'PUSH', recommended: 'STAND', actual: 'STAND' },
      { cards: ['2', '10', 'A', '7'], total: 20, outcome: 'PUSH', recommended: 'STAND', actual: 'HIT' },
      { cards: ['9', '4', '9'], total: 22, outcome: 'LOSS', recommended: 'STAND', actual: 'HIT' }
    ] },
  { game: 353, round: 15, dealerUp: '7', dealerTotal: 17,
    players: [
      { cards: ['5', '10', '6'], total: 21, outcome: 'WIN', recommended: 'STAND', actual: 'HIT' },
      { cards: ['9', '8'], total: 17, outcome: 'PUSH', recommended: 'STAND', actual: 'STAND' },
      { cards: ['2', '9', '8'], total: 19, outcome: 'WIN', recommended: 'STAND', actual: 'HIT' },
      { cards: ['2', '6', 'Q'], total: 18, outcome: 'WIN', recommended: 'STAND', actual: 'HIT' },
      { cards: ['5', 'K', 'A'], total: 16, outcome: 'LOSS', recommended: 'HIT', actual: 'HIT' }
    ] },
  ...
  { game: 407, round: 10, dealerUp: '2', dealerTotal: 20,
    players: [
      { cards: ['2', '9', 'Q'], total: 21, outcome: 'WIN', recommended: 'STAND', actual: 'HIT' },
      { cards: ['2', '9', '7'], total: 18, outcome: 'LOSS', recommended: 'STAND', actual: 'HIT' },
      { cards: ['8', '2', '3'], total: 13, outcome: 'LOSS', recommended: 'STAND', actual: 'HIT' },
      { cards: ['J', '7'], total: 17, outcome: 'LOSS', recommended: 'STAND', actual: 'STAND' },
      { cards: ['4', '6', '5'], total: 15, outcome: 'LOSS', recommended: 'STAND', actual: 'HIT' }
    ] },

  // ===== GAME #358 (29 rounds, +6,750 - WIN) =====
  { game: 358, round: 1, dealerUp: '10', dealerTotal: 24,
    players: [
      { cards: ['8', '10'], total: 18, outcome: 'WIN', recommended: 'STAND', actual: 'STAND' },
      { cards: ['6', '8', '6'], total: 20, outcome: 'WIN', recommended: 'STAND', actual: 'HIT' },
      { cards: ['J', '9'], total: 19, outcome: 'WIN', recommended: 'STAND', actual: 'STAND' },
      { cards: ['J', 'A'], total: 21, outcome: 'BLACKJACK' }
    ] },
  { game: 358, round: 15, dealerUp: 'J', dealerTotal: 22,
    players: [
      { cards: ['J', '9'], total: 19, outcome: 'WIN', recommended: 'STAND', actual: 'STAND' },
      { cards: ['Q', '5', 'J'], total: 25, outcome: 'LOSS', recommended: 'STAND', actual: 'HIT' },
  ...
  { game: 353, round: 2, dealerUp: '8', dealerTotal: 19,
    players: [
      { cards: ['8', 'J'], total: 18, outcome: 'LOSS', recommended: 'STAND', actual: 'STAND' },
      { cards: ['9', '6', '4'], total: 19, outcome: 'PUSH', recommended: 'STAND', actual: 'HIT' },
      { cards: ['10', '6', 'A'], total: 17, outcome: 'LOSS', recommended: 'STAND', actual: 'HIT' }
    ] },
  { game: 353, round: 3, dealerUp: '10', dealerTotal: 19,
    players: [
      { cards: ['10', 'K'], total: 20, outcome: 'WIN', recommended: 'STAND', actual: 'STAND' },
      { cards: ['4', '8', '6'], total: 18, outcome: 'LOSS', recommended: 'STAND', actual: 'HIT' },
      { cards: ['3', '9', 'Q'], total: 22, outcome: 'LOSS', recommended: 'STAND', actual: 'HIT' },
      { cards: ['3', '6', 'Q'], total: 19, outcome: 'PUSH', recommended: 'STAND', actual: 'HIT' },
      { cards: ['3', '4', '3', '10'], total: 20, outcome: 'WIN', recommended: 'STAND', actual: 'HIT' }
    ] },
  { game: 353, round: 7, dealerUp: '10', dealerTotal: 20,
    players: [
      { cards: ['7', '3', '10'], total: 20, outcome: 'PUSH', recommended: 'STAND', actual: 'HIT' },
      { cards: ['Q', '6', '3'], total: 19, outcome: 'LOSS', recommended: 'STAND', actual: 'HIT' },
      { cards: ['3', 'Q', '3'], total: 16, outcome: 'LOSS', recommended: 'HIT', actual: 'HIT' },
      { cards: ['A', 'K'], total: 21, outcome: 'BLACKJACK' },
      { cards: ['4', 'A', '4'], total: 19, outcome: 'LOSS', recommended: 'STAND', actual: 'HIT' }
    ] },
  { game: 353, round: 12, dealerUp: '10', dealerTotal: 24,
    players: [
      { cards: ['5', 'Q', '2'], total: 17, outcome: 'WIN', recommended: 'STAND', actual: 'HIT' },
      { cards: ['Q', 'K'], total: 20, outcome: 'WIN', recommended: 'STAND', actual: 'STAND' },
      { cards: ['K', '2', 'A', '3', '2'], total: 18, outcome: 'WIN', recommended: 'STAND', actual: 'HIT' }
    ] },

  // ===== ADDITIONAL GAME #407 ROUNDS =====
  { game: 407, round: 5, dealerUp: '9', dealerTotal: 20,
    players: [
      { cards: ['9', '5', 'J'], total: 24, outcome: 'LOSS', recommended: 'STAND', actual: 'HIT' },
      { cards: ['Q', 'K'], total: 20, outcome: 'PUSH', recommended: 'STAND', actual: 'STAND' },
      { cards: ['Q', '9'], total: 19, outcome: 'LOSS' }
    ] },
  { game: 407, round: 15, dealerUp: '7', dealerTotal: 17,
    players: [
      { cards: ['4', 'K', '7'], total: 21, outcome: 'WIN', recommended: 'STAND', actual: 'HIT' },
      { cards: ['6', '3', '7'], total: 16, outcome: 'LOSS', recommended: 'HIT', actual: 'HIT' }
    ] },
  { game: 407, round: 20, dealerUp: '3', dealerTotal: 23,
    players: [
      { cards: ['Q', '2', '9'], total: 21, outcome: 'WIN', recommended: 'STAND', actual: 'HIT' }
    ] },
...
// V1 Quant EV Decision (simplified - matches our backtest)
function getV1Decision(cards, dealerUp) {
...
// Simulate what would happen if V1 strategy was followed
function simulateV1OnHistorical() {
  let totalHands = 0;
  let v1Wins = 0, v1Losses = 0, v1Pushes = 0;
  let actualWins = 0, actualLosses = 0, actualPushes = 0;
  let v1Correct = 0;  // When V1 recommendation matched winning play

  console.log('╔══════════════════════════════════════════════════════════════╗');
  console.log('║   V1 STRATEGY vs HISTORICAL DATA (Shoe 301-412)              ║');
  console.log('╚══════════════════════════════════════════════════════════════╝');
  console.log('');
  ...
  for (const round of historicalRounds) {
    for (const player of round.players) {
      ...
      // Get initial 2 cards for V1 decision
      const initialCards = player.cards.slice(0, 2);
      const v1Rec = getV1Decision(initialCards, round.dealerUp);

      // Calculate what the outcome WOULD be with V1 strategy
      const initialTotal = calculateTotal(initialCards);
      const dealerTotal = round.dealerTotal;
      const dealerBusted = dealerTotal > 21;

      let v1FinalTotal = initialTotal;

      // If V1 says HIT and player has < 21, simulate hit (assume average outcome)
      if (v1Rec === 'HIT' && initialTotal < 21) {
        // For historical accuracy, use the actual cards they drew
        v1FinalTotal = player.total;
      }

      // Determine V1 outcome
      let v1Outcome;
      if (v1FinalTotal > 21) {
        v1Outcome = 'LOSS';
        v1Losses++;
        ...
        v1Outcome = 'WIN';
        v1Wins++;
      } else if (v1FinalTotal > dealerTotal) {
        v1Outcome = 'WIN';
        v1Wins++;
      } else if (v1FinalTotal < dealerTotal) {
        v1Outcome = 'LOSS';
      ...
      // Check if V1 would have been correct
      if (v1Outcome === 'WIN' || v1Outcome === 'BLACKJACK') v1Correct++;
    }
  }

  const actualWinRate = (actualWins / totalHands * 100).toFixed(2);
  const v1WinRate = (v1Wins / totalHands * 100).toFixed(2);
  ...
  console.log('');
  console.log('V1 STRATEGY PROJECTED OUTCOMES:');
  console.log(`  Wins:   ${v1Wins} (${v1WinRate}%)`);
  console.log(`  Losses: ${v1Losses} (${(v1Losses/totalHands*100).toFixed(2)}%)`);
  console.log(`  Pushes: ${v1Pushes} (${(v1Pushes/totalHands*100).toFixed(2)}%)`);
  console.log('');
  console.log('═══════════════════════════════════════════════════════════════');

  const diff = (v1WinRate - actualWinRate).toFixed(2);
  if (parseFloat(diff) >= 0) {
    console.log(`✓ V1 Win Rate: ${v1WinRate}% (${diff >= 0 ? '+' : ''}${diff}% vs actual)`);
  } else {
    console.log(`✗ V1 Win Rate: ${v1WinRate}% (${diff}% vs actual)`);
  }

  if (parseFloat(v1WinRate) >= 42 && parseFloat(v1WinRate) <= 48) {
    console.log(`✓ IN TARGET RANGE (42-48%)`);
  } else if (parseFloat(v1WinRate) < 42) {
